...
<div class="fixed inset-0 -z-10 overflow-hidden">
  <div class="absolute inset-0 bg-linear-to-br from-purple-900 via-blue-900 to-indigo-900 animate-linear-xy"></div>
  <div class="absolute inset-0 bg-linear-to-tr from-pink-500/20 via-transparent to-cyan-500/20 animate-linear-xy delay-700"></div>
  ...
  >
    ...
    <div
      class="relative backdrop-blur-2xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl overflow-hidden
             before:absolute before:inset-0 before:bg-linear-to-br before:from-white/10 before:to-transparent before:rounded-3xl
             animate-border-glow"
    >
      <div class="absolute inset-0 bg-linear-to-br from-purple-600/20 via-transparent to-pink-600/20 animate-pulse"></div>
      ...
      <div class="relative p-10">
        ...
        <form method="POST" class="space-y-6" use:enhance={() => {
          ...
          >
            ...
            <div class="absolute inset-0 bg-linear-to-r from-transparent via-white to-transparent opacity-0 
